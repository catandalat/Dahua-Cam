...
def _detection_out(d: VehicleDetection) -> dict[str, Any]:
    return {
        ...
        "plate_color": d.plate_color if d.plate_color and str(d.plate_color).lower() != "unknown" else None,
        "vehicle_brand": d.vehicle_brand if d.vehicle_brand and str(d.vehicle_brand).lower() != "unknown" else None,
        "vehicle_model": d.vehicle_model if d.vehicle_model and str(d.vehicle_model).lower() != "unknown" else None,
        "vehicle_category": d.vehicle_category if d.vehicle_category and str(d.vehicle_category).lower() != "unknown" else None,
        "vehicle_class": d.vehicle_class,
        "vehicle_color": d.vehicle_color if d.vehicle_color and str(d.vehicle_color).lower() != "unknown" else None,
